    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity httpSecurity) throws Exception{
        return httpSecurity
                ...
                .authorizeHttpRequests(
                        req->req.requestMatchers("/login/**","/register/**","/favoris/clientfavoris/{clientId}","/favoris/supprimer/{clientId}/{planteId}","delete/savedarticle/{articleId}/client/{clientId}", "/admin/plantes","/plantes/{clientId}","/save_article","/savedarticle/byclient/{clientId}","/favoris/supprimer/{clientId}/{planteId}","/error","/plantes/**","/articles/**","/medicaments/getall","/favoris/plantes/{clientId}","/sante/medicaments/add","/favoris/ajouter/{clientId}/{planteId}","/notifications/**","/sante/medicaments/delete/{id}","/sante/maladies/add","/allergies/getall","/sante/allergies/add","/delete_article/byclient/{clientId}/article/{articleId}","/sante/allergies/delete/{id}","/sante/maladies/delete/{id}","/maladies/getall","/admin/clients","/commentaires","/admin/clients/{id}","/clients/{id}","/clients/{id}/medicament","/clients/{id}/allergie","/clients/{id}/maladie")
                                .permitAll()
